...
/*   Updated: 2023/06/02 13:11:20 by irifarac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//Utilities cylinder
double		ft_calc_m_cyl(t_cylinder *cyl, t_ray *ray, double limits[2],
				double t);
...
bool		ft_cyl_inter(t_cylinder *cyl, t_ray *ray, double limits[2],
				double t);
#endif
