...
/*   Updated: 2023/05/29 10:30:26 by irifarac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static double	ft_calc_a(t_ray *ray)
{
	...
	second = ray->direction.y * ray->direction.y;
	return (first + second);
}
...
static double	ft_calc_b(t_cylinder *cyl, t_ray *ray)
{
	...
	second = ray->direction.y * pos_center.y;
...
static double	ft_calc_c(t_cylinder *cyl, t_ray *ray)
{
	...
	second = (ray->origin.y - cyl->y) * (ray->origin.y - cyl->y);
