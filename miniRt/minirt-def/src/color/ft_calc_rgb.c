...
/*   Updated: 2023/04/06 14:03:12 by irifarac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_rgb	ft_max_to_one(t_rgb light_color)
{
	...
	if (light_color.r > 255)
		value = light_color.r;
	if (light_color.g > 255 && light_color.g > value)
		value = light_color.g;
	if (light_color.b > 255 && light_color.b > value)
		value = light_color.b;
/*	ret.r = light_color.r / value;
	ret.g = light_color.g / value;
	ret.b = light_color.b / value;*/
	//if (light_color.r > 255 || light_color.g > 255 || light_color.b > 255)
